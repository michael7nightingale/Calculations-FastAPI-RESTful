...
from api.science.schemas import RequestSchema
from api.cabinet.schemas import HistorySchema
...
async def build_template(request: RequestSchema,
    ...
    logger.debug(f"Getting formula params by name: {request.formula_slug}")
    ...
    try:
        ...
        # заносить результат в историю
            if request.user_id is not None:
                ...
                await history_repo.create(history_schema)
